...
class VideoCardListFragment : Fragment(R.layout.fragment_cooler_list) {
    ...
    private val adapter: VideoCardAdapter by lazy { VideoCardAdapter{} }

    @Inject
    lateinit var factory: ViewModelProvider.Factory
    
    private val viewModel: VideoCardViewModel by viewModels { factory }
    ...
    class Screen : FragmentScreen {
        override fun createFragment(factory: androidx.fragment.app.FragmentFactory): Fragment = VideoCardListFragment()
    }
}
